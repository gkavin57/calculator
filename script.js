...
top_nav.classList.add("bg-warning")

var title = document.createElement("div")
// title.classList.add("navbar-brand")
title.classList.add("ms-5") 
...
main_container.classList.add("mt-3")
...
tarea.style.fontSize = "30px"
tarea.style.borderRadius = "50px"
tarea.style.padding = "20px 10px"
tarea.style.lineHeight = "28px"
tarea.style.border = "4px solid green"
col_1.append(tarea)


var col_2 = document.createElement("div")
col_2.classList.add("col-8", "mb-4")
...
function numberCreate(value, color, id){
    ...
    number.style.borderRadius = "10px solid blue"
    number_.appendChild(number)
    return number_;
}

let n7 = numberCreate("7", "btn-outline-primary", "seven")
let n8 = numberCreate("8", "btn-outline-primary", "eight")
let n9 = numberCreate("9", "btn-outline-primary", "nine")
let n_mod = numberCreate(" % ", "btn-outline-success", "n_mod")

col_2.append(n7, n8, n9, n_mod)

var col_3 = document.createElement("div")
col_3.classList.add("col-8", "mb-4")

let n4 = numberCreate("4", "btn-outline-primary", "four")
let n5 = numberCreate("5", "btn-outline-primary", "five")
let n6 = numberCreate("6", "btn-outline-primary", "six")
let n_div = numberCreate(" / ", "btn-outline-success", "n_div")

col_3.append(n4, n5, n6, n_div)

var col_4 = document.createElement("div")
col_4.classList.add("col-8", "mb-4")

let n1 = numberCreate("1", "btn-outline-primary", "one")
let n2 = numberCreate("2", "btn-outline-primary", "two")
let n3 = numberCreate("3", "btn-outline-primary", "three")
let n_mul = numberCreate(" * ", "btn-outline-success", "n_mul")

col_4.append(n1, n2, n3, n_mul)

var col_5 = document.createElement("div")
col_5.classList.add("col-8", "mb-4")

let n_dot = numberCreate(".", "btn-outline-primary", "n_dot")
let n0 = numberCreate("0", "btn-outline-primary", "zero")
...
col_6.classList.add("col-8", "mb-4")

let n_ce = numberCreate("CE", "btn-outline-warning", "n_ce")
let n_back = numberCreate("\u232b", "btn-outline-danger", "n_back")
let n_eval = numberCreate("=", "btn-outline-dark", "n_eval")
